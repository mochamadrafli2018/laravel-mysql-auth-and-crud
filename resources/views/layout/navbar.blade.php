...
<head>
    ...
    <style>
        ...
        .form-bootstrap {
            box-shadow: 0px 1px 5px 2px #c4c4c4;
            margin: 20px auto;
            padding: 3%;
            width: 50%;
        }
...
<body class="antialiased">
    ...
    <form class="form-bootstrap">
        ...
        <div class="mb-3">
            ...
            <input type="nama" class="form-control" id="exampleInputNIM1">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3 form-check">
            ...
            <label class="form-check-label" for="exampleCheck1">Data yang di input adalah data yang sah</label>
        </div>
